...
var VdsInstrumentAgent = {
  ...
  hook: function (t, e) {
    return function () {
      ...
      if (this._growing_app_ && "onShow" !== t ? i = e.apply(this, arguments) : this._growing_page_ && -1 === ["onShow", "onLoad", "onTabItemTap", "onHide"].indexOf(t) && (i = e.apply(this, arguments)), this._growing_app_ && -1 !== VdsInstrumentAgent.appHandlers.indexOf(t)) {
        try {
