...
import { removeItem, setItem, ZKEYS_TOKEN, getPathArray } from '../utils'
import { EnumRoleType } from 'enums'
import { query, logout, sort } from 'services/app'
  ...
  effects: {
    ...
    * query ({
      ...
      if (success && Data) {
        ...
        const { permissions, safety_ttl } = Data
        setItem('safety_ttl', safety_ttl)
        let menu = list
