...
import { query, create, remove, edit, workflowSort, contract } from '../../../services/detail'
...
export default modelExtend(model,{
	...
	effects: {
		...
		* workflowSort ({ payload }, { call, put, select }) {
			const data = yield call(workflowSort, { ...payload })
			return data
		},
